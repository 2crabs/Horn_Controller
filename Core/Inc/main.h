...
#define CUR_Pin GPIO_PIN_6
#define CUR_GPIO_Port GPIOA
#define CUR_FAULT_Pin GPIO_PIN_7
#define CUR_FAULT_GPIO_Port GPIOA
#define HORN_IN_Pin GPIO_PIN_0
#define HORN_IN_GPIO_Port GPIOB
